...
public class AuthController {
    ...
    @GetMapping("/welcome")		//http://localhost:7000/auth/welcome
    public String welcome() {
        return "Welcome this endpoint is not secure";
    }

    @PostMapping("/new")	//http://localhost:7000/auth/new
    ...
    @PostMapping("/authenticate")		//http://localhost:7000/auth/authenticate
